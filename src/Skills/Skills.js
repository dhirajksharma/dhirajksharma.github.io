...
class Skills extends React.Component{
        ...
        entries.forEach((entry)=>{
          if(entry.isIntersecting){
            document.querySelectorAll('.child').forEach(ele=>{
                ele.classList.add('childShow');
            })
            document.querySelectorAll('.children').forEach(ele=>{
                ele.classList.add('childrenShow');
            })
          }
        })
      })
    ...
    componentDidMount(){
        this.observer.observe(document.querySelector('.myBubbleUI'));
    }
          ...
          <div className="w-full h-full flex flex-col">
            ...
            <BubbleUI options={window.innerWidth<640?options1:window.innerWidth<1080?options2:window.innerWidth<1536?options3:options4} className="myBubbleUI hideBubble">
                ...
                <div className="child bg-[#03599C]">
                    ...
                    <svg viewBox="0 0 128 128" width='70%' className="">
                    ...
                    <p className="children childrenPara text-white">C</p>
                </div>
                
                <div className="child bg-[#9C033A]">
                    <div className="children childrenDiv">
                    ...
                    <p className="children childrenPara text-white">C Plus Plus</p>
                </div>

                <div className="child bg-[#0d70b6]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">CSS</p>
                </div>
                               
                <div className="child bg-[#fc611f]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">HTML</p>
                </div>

                <div className="child bg-[#0d5181]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">jQuery</p>
                </div>
                
                <div className="child bg-[#1093bb]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    <path d="M64.004 25.602c-17.067 0-27.73 8.53-32 25.597 6.398-8.531 13.867-11.73 22.398-9.597 4.871 1.214 8.352 4.746 12.207 8.66C72.883 56.629 80.145 64 96.004 64c17.066 0 27.73-8.531 32-25.602-6.399 8.536-13.867 11.735-22.399 9.602-4.87-1.215-8.347-4.746-12.207-8.66-6.27-6.367-13.53-13.738-29.394-13.738zM32.004 64c-17.066 0-27.73 8.531-32 25.602C6.402 81.066 13.87 77.867 22.402 80c4.871 1.215 8.352 4.746 12.207 8.66 6.274 6.367 13.536 13.738 29.395 13.738 17.066 0 27.73-8.53 32-25.597-6.399 8.531-13.867 11.73-22.399 9.597-4.87-1.214-8.347-4.746-12.207-8.66C55.128 71.371 47.868 64 32.004 64zm0 0" fill="#2298bd"></path>
                    </svg>
                    </div>                 
                    <p className="children childrenPara text-white">TailwindCSS</p>
                </div>
                
                <div className="child bg-[#f8dd30]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                ...
                <div className="child bg-[#4f61c9]">
                    ...
                    <p className="children childrenPara text-white">TypeScript</p>
                </div>    

                <div className="child bg-[#283349]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 257 257">
                    <rect width="257" height="257" rx="128.5" fill="url(#logo)"></rect>
                    <path d="M69.558 133.985l87.592-86.9891c1.636-1.6251 4.27.3525 3.165 2.377l-32.601 59.7521c-.728 1.332.237 2.958 1.755 2.958h56.34c1.815 0 2.691 2.223 1.364 3.462l-98.7278 92.142c-1.7702 1.652-4.4051-.676-2.9839-2.636l46.7357-64.473c.958-1.322.014-3.174-1.619-3.174H70.9673c-1.7851 0-2.6759-2.161-1.4093-3.419z" fill="#1a202c"></path>
                    </svg>
                    </div>                 
                    <p className="children childrenPara text-white">Chakra UI</p>
                </div>      
                
                <div className="child bg-[#fd4218]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">Git</p>
                </div>
                
                <div className="child bg-[#692fc5]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">Redux</p>
                </div>

                <div className="child bg-[#3ba528]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">MongoDB</p>
                </div>
                
                <div className="child bg-[#333333]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara text-white">Express</p>
                </div>

                <div className="child bg-[#8fe922]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
                    ...
                    <p className="children childrenPara">Node.JS</p>
                </div>

                <div className="child bg-[#16749c]">
                    <div className="children childrenDiv">
                    <svg viewBox="0 0 128 128" width='70%'>
