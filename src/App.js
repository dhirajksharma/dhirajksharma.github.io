  ...
  render(){
    ...
    return (
        ...
        <div id='appHolder' className="hidden justify-center items-center h-[100dvh] relative">
          <div id='app' className="h-[100dvh] lg:h-[95dvh] lg:aspect-[3/5] flex flex-col items-center xl:items-start lg:ml-4 lg:rounded-2xl shadow-[2px_8px_22px_5px_rgba(0,0,0,0.1)]">
            ...
            <div className="flex justify-between items-center pt-2 w-screen h-[80px] sm:h-[120px] lg:h-[70px] 2xl:h-[100px] lg:w-full">
              ...
              <h1 className="mr-5 sm:mr-6 ml-0 text-right sm:text-xl lg:text-base 2xl:text-2xl font-outfit font-light !leading-snug">Frontend Designer<br></br>& Developer</h1>
            </div>
          ...
          {//bottom nav bar for mobile displays
            (window.innerWidth >= 1024 &&
