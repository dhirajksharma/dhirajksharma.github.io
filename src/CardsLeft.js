...
class CardsLeft extends React.Component{
    constructor(props){
        super(props);
    }
    ...
    render(){
        return (
            <div class="relative z-10">
                ...
                />
                <div class="timeline-container timeline-container-left projhiddenleft mb-6">
                    <div
                    ...
                    <div class="bg-slate-100 p-4 xs:p-6 rounded-md shadow-md">
                        ...
                        <p class="pt-1 text-sm xs:text-base font-mono tracking-tight">
                            {this.props.body}
                        </p>
