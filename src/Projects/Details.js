        ...
        return (
            <div id={this.props.prjid} className="w-[95vw] lg:w-full hidden flex-col items-center overflow-hidden">
              <button
                ...
                className="z-10 bg-gray-800 shadow-[0px_0px_15px_5px] shadow-gray-400 hover:shadow-gray-200 text-white hover:bg-gray-200 hover:text-black px-4 py-2 text-xl rounded-full font-montserrat lg:mx-2 fixed top-14 opacity-0 -translate-y-28 transition-opacity transition-transform ease-out duration-1000">
                  X
              </button>
